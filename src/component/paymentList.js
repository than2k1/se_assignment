    ...
    return(
        <div className='singleItemPay'>
            ...
            <div className='billItem'>
                ...
                <p>
                <button className='btn' onClick={decrease.bind(this,itemSingle.id)} style={btnStyle}>-</button>
                <span style={{marginLeft: '3px', marginRight:'3px'}}>{itemSingle.amount}</span>
                <button className='btn' onClick={increase.bind(this,itemSingle.id)}>+</button>
                </p>
                
                <span className='btnDelete' onClick={deleteSingle.bind(this,itemSingle.id)}><FaWindowClose style={{color: 'rgb(76 88 107)'}}/></span>
            </div>
